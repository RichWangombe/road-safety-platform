export const tasksData = [
  // Activity 101: Guardrail Installation
  {
    ...
    name: "Survey Site A",
    status: "completed",
    assignedTo: "Team Lead Alpha",
    dueDate: "2025-02-28",
  },
  {
    id: 10102,
    activityId: 101,
    name: "Install Section 1",
    status: "active",
    assignedTo: "Team Lead Alpha",
    dueDate: "2025-03-15",
  },
  {
    id: 10103,
    activityId: 101,
    name: "Inspect Section 1",
    status: "pending",
    assignedTo: "Supervisor Mike",
    dueDate: "2025-03-20",
  },
  ...
  // Activity 202: Congestion Monitoring System
  {
    id: 20201,
    activityId: 202,
    name: "Deploy Sensor Grid 1",
    status: "completed",
    assignedTo: "Team Lead Bravo",
    dueDate: "2025-05-10",
  },
  {
    id: 20202,
    activityId: 202,
    name: "Calibrate Sensor Grid 1",
    status: "active",
    assignedTo: "Team Lead Bravo",
    dueDate: "2025-05-20",
  },
...
export const activitiesData = [
  ...
  },
  {
    id: 202,
    programId: 2,
    name: "Congestion Monitoring System",
    status: "active",
    priority: "high",
...
export const resourcesData = [
  {
    ...
    description:
      "The official government strategy document outlining key objectives and action plans.",
  ...
  },
  {
    ...
    description:
      "A comprehensive video tutorial on best practices for defensive driving.",
  ...
  },
  {
    ...
    description:
      "Standard template for reporting road safety incidents. Please download and fill.",
  ...
  },
  {
    ...
    description:
      "A step-by-step guide for conducting safety audits in school zones.",
    category: "Guidelines",
    type: "Guide",
  ...
  },
  {
    ...
    description:
      "A detailed report on the performance and outcomes of all road safety programs in 2022.",
    category: "Official Documents",
    type: "PDF",
  ...
  },
  {
    ...
    description:
      "Resources and templates for running effective community engagement sessions.",
    category: "Guidelines",
    type: "DOC",
