  ...
  resourcesData: [
    {
      ...
      description: "A comprehensive guide to road safety.",
      category: "Official Documents",
      type: "PDF",
    },
    {
      id: 2,
      title: "Driver Training Video",
      description: "A video for new drivers.",
    ...
    },
    {
      ...
      description: "Form for reporting accidents.",
  ...
  return render(
    ...
    >
      <ThemeProvider theme={ntsaTheme}>
        <AuthProvider value={{ user: { role: "Program Manager" } }}>
          {ui}
        </AuthProvider>
      </ThemeProvider>
    </BrowserRouter>,
...
describe("ResourceCentrePage", () => {
  ...
  it("filters resources by category", async () => {
    ...
    const trainingTab = await screen.findByRole("tab", {
      name: /training materials/i,
    });
