...
import { Box, Typography, Paper, Grid, Chip, Button, Breadcrumbs, Link } from '@mui/material';
...
const ProgramDetailPage = () => {
  ...
  if (!program) {
    return (
      <Box>
        <Typography variant="h4" color="error">Program not found</Typography>
      ...
      <Paper sx={{ p: 3, mb: 4 }}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6} md={4}>
            ...
            <Chip label={program.status} size="small" sx={{ backgroundColor: statusColors.bg, color: statusColors.color, textTransform: 'capitalize' }} />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <Typography variant="subtitle2" color="text.secondary">Priority</Typography>
            <Chip label={program.priority} size="small" sx={{ backgroundColor: priorityColors.bg, color: priorityColors.color, textTransform: 'capitalize' }} />
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            ...
            <Typography variant="body2">${program.budget.toLocaleString()}</Typography>
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <Typography variant="subtitle2" color="text.secondary">Timeline</Typography>
            <Typography variant="body2">{program.startDate} to {program.endDate}</Typography>
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <Typography variant="subtitle2" color="text.secondary">Program Manager</Typography>
