...
if (
  ...
  typeof global.Headers.prototype.all === "undefined"
) {
...
// Suppress noisy MUI Grid legacy prop warnings in test output
const originalWarn = console.warn.bind(console);
beforeAll(() => {
  jest.spyOn(console, "warn").mockImplementation((message, ...args) => {
    if (
      typeof message === "string" &&
      message.startsWith("MUI Grid: The `") &&
      message.includes("prop has been removed")
    ) {
      return; // skip
    }
