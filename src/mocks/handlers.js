...
const mockStakeholders = [
  {
    ...
    email: "john.d@gov.com",
    phone: "111-111-1111",
    engagement_level: "High",
    last_interaction_date: "2025-07-20",
  },
  {
    id: 2,
    name: "API Jane Smith",
    ...
    email: "jane.s@ngo.org",
    phone: "222-222-2222",
    engagement_level: "Medium",
    last_interaction_date: "2025-07-21",
  },
...
export const handlers = [
  ...
  rest.get("http://localhost:3001/api/v1/stakeholders", (req, res, ctx) => {
    return res(ctx.status(200), ctx.json(mockStakeholders));
  }),
];
